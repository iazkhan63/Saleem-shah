...
def acak(b):
	...
	print "  \033[1;91m┬л---тАвтЧИтАв---Developed By baloch-hackerтАвтЧИтАв-┬╗" #Dev:baloch_hacker
...
def menu():
	...
	print "\033[1;95mтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдoks.append(user+pass1)
			else:
				if 'www.facebook.com' in q["error_msg"]:
...
if name == 'main':тАвтЧИтАвтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧд
